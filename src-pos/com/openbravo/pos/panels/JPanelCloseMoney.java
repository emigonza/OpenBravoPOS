...
public class JPanelCloseMoney extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    private void loadData() throws BasicException {
        ...
        if (m_PaymentsToClose.getPayments() != 0 || m_PaymentsToClose.getSales() != 0) {
            ...
            m_jRefound.setText(m_PaymentsToClose.printRefound());
            m_jDiscounts.setText(m_PaymentsToClose.printDiscount());
    ...
    private void printPayments(String report) {
        ...
        if (sresource == null) {
            ...
            try {
                ...
                script.put("infoRUC", m_dlSystem.getResourceAsText("info.RUC"));
                script.put("infoAddress", m_dlSystem.getResourceAsText("info.address"));
                script.put("infoTel", m_dlSystem.getResourceAsText("info.tel"));
    ...
    private void sendEmail(){
        ...
        StringBuffer text = new StringBuffer(AppLocal.getIntString("email.closeCash"));
        text.append("\n\n++++++++++++++++++++++++++\n");
        text.append(m_TTP.getTicketText());
        text.append("\n++++++++++++++++++++++++++\n");

        emailSender.send(list, eProperties.getProperty("from"), "Cierre de caja", text.toString());
    }

    private class FormatsPayment extends Formats {
        protected String formatValueInt(Object value) {
            String val = (String) value;
            int i = val.indexOf("magcard");
            if(i < 0)
                return AppLocal.getIntString("transpayment." + (String) value);
            else{
                return AppLocal.getIntString("transpayment." + val.substring(0,7)) + val.substring(7);
            }
    ...
    private void initComponents() {
        ...
        m_jRefound = new javax.swing.JTextField();
        m_jDiscounts = new javax.swing.JTextField();
        ...
        jLabel8.setText(AppLocal.getIntString("label.refunds"));

        jLabel9.setText(AppLocal.getIntString("label.discounts"));

        m_jRefound.setEditable(false);
        m_jRefound.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        m_jDiscounts.setEditable(false);
        m_jDiscounts.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addComponent(m_jRefound, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(jLabel9)
                        .addGap(22, 22, 22)
                        .addComponent(m_jDiscounts, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel8)
                    .addComponent(m_jRefound, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(m_jDiscounts, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel9))))
        );
...
private void m_jPrintCashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jPrintCashActionPerformed
    ...
    String sendEmailInPartialCash = m_dlSystem.getResourceAsText("email.sendInPartialCash");
    if(sendEmailInPartialCash != null && sendEmailInPartialCash.trim().equalsIgnoreCase("true")){
        sendEmail();
    }
    ...
    private javax.swing.JTextField m_jDiscounts;
    ...
    private javax.swing.JTextField m_jRefound;
