...
//        m_jTendered.addEditorKeys(m_jKeys);
        m_jMoneyEuros.addPropertyChangeListener("Edition", new RecalculateState());
        m_jMoneyEuros.addEditorKeys(m_jKeys);
        
        jTextField1.addPropertyChangeListener("Edition", new RecalculateNotes());
    ...
    public void activate(CustomerInfoExt customerext, double dTotal, String transID) {
        ...
        //m_jTendered.reset();
        m_jMoneyEuros.reset();
        m_jMoneyEuros.setDoubleValue(dTotal);
...
//                m_jTendered.activate();  
    ...
    public PaymentInfo executePayment() {
        PaymentInfoTicket paymentInfoTicket = new PaymentInfoTicket(m_dPaid, "debt");
        paymentInfoTicket.setNotes(jTextField1.getText());
        return paymentInfoTicket;      
    }
...
//            m_jMoneyEuros.setText(null);
            m_jMoneyEuros.setDoubleValue(0.0);
...
//            m_jMoneyEuros.setDoubleValue(new Double(m_dPaid));
    ...
    private class RecalculateNotes implements PropertyChangeListener {
        public void propertyChange(PropertyChangeEvent evt) {
            printNote();
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel3);
        jLabel3.setBounds(20, 110, 100, 15);

        m_jName.setEditable(false);
        jPanel4.add(m_jName);
        m_jName.setBounds(120, 110, 200, 19);

        jLabel12.setText(AppLocal.getIntString("label.notes")); // NOI18N
        jPanel4.add(jLabel12);
        jLabel12.setBounds(20, 60, 100, 15);
        ...
        jScrollPane1.setBounds(120, 140, 200, 30);
        jPanel4.add(jTextField1);
        jTextField1.setBounds(120, 60, 200, 40);

        jLabel13.setText(AppLocal.getIntString("label.notes")); // NOI18N
        jPanel4.add(jLabel13);
        jLabel13.setBounds(20, 140, 100, 15);
