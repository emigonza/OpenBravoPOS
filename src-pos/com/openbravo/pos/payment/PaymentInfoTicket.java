...
public class PaymentInfoTicket extends PaymentInfo implements SerializableRead  {
    ...
    public void readValues(DataRead dr) throws BasicException {
        ...
        this.setNotes(dr.getString(4));
        m_change = dr.getDouble(5);
        m_sHolderName = dr.getString(6);
    }
    ...
    public String printPaid() {
        return Formats.CURRENCY.formatValue(new Double(m_dTicket + m_change));
    }
    ...
    public String printChange() {
        return Formats.CURRENCY.formatValue(new Double(m_change));
    }
