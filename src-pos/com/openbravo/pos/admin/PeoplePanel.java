...
public class PeoplePanel extends JPanelTable {
    ...
    protected void init() {
        ...
        /**
         * Modificacion para que solo los usuarios con el rol de administrador del sistema puedan ver y modificar a los administradores
         * Change so that only users with Administrator role can view and modify system administrators
         */
        if(!app.getAppUserView().getUser().hasPermission("com.openbravo.pos.smj.SyncPanel")){
            tpeople.setWhere(" where id != '0'");
        }
