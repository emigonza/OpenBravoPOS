...
public class ProductInfoExt {
    ...
    protected double m_dPriceSellSpecial;
    protected double m_dPriceSellMin;
    protected String m_dUnit;
    ...
    public void setUnit(String m_dUnit) {
        this.m_dUnit = m_dUnit;
    }
    ...
    public static SerializerRead getSerializerRead() {
        return new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
            ...
            /**
             * modificacion para agregar unidades por defecto - 
             * modification to add default units
             */
            try{
                product.m_dPriceSellSpecial = dr.getDouble(14).doubleValue();
                product.m_dPriceSellMin = dr.getDouble(15).doubleValue();
                product.m_dUnit = dr.getString(16);
            }catch(Exception e){
                product.m_dPriceSellSpecial = dr.getDouble(8).doubleValue();
                product.m_dPriceSellMin = dr.getDouble(8).doubleValue();
                product.m_dUnit = "UND";
            }
            return product;
        }};
    ...
    public final double getPriceSellSpecial() {
        return m_dPriceSellSpecial;
    }

    public final void setPriceSellSpecial(double dPrice) {
        m_dPriceSellSpecial = dPrice;
    }

    public final double getPriceSellSpecialTax(TaxInfo tax) {
        return m_dPriceSellSpecial * (1.0 + tax.getRate());
    }

    public String printPriceSellSpecial() {
        return Formats.CURRENCY.formatValue(new Double(getPriceSellSpecial()));
    }

    public String printPriceSellSpecialTax(TaxInfo tax) {
        return Formats.CURRENCY.formatValue(new Double(getPriceSellSpecialTax(tax)));
    }
    
    
    
    public final double getPriceSellMin() {
        return m_dPriceSellMin;
    }

    public final void setPriceSellMin(double dPrice) {
        m_dPriceSellMin = dPrice;
    }

    public final double getPriceSellMinTax(TaxInfo tax) {
        return m_dPriceSellMin * (1.0 + tax.getRate());
    }

    public String printPriceSellMin() {
        return Formats.CURRENCY.formatValue(new Double(getPriceSellMin()));
    }

    public String printPriceSellMinTax(TaxInfo tax) {
        return Formats.CURRENCY.formatValue(new Double(getPriceSellMinTax(tax)));
    }
