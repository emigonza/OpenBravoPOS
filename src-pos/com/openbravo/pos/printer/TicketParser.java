...
public class TicketParser extends DefaultHandler {
    ...
    private StringBuffer textToEmail;
    ...
    /**
     * modificacion para transformacion de informacion para imprimir a HTML para envio por email - textToEmail
     * modification for information processing to print to HTML for sending email - textToEmail 
     */
    ...
    public void startDocument() throws SAXException {
        ...
        textToEmail = new StringBuffer();
        textToEmail.append("<table>");
        textSeparator = "";
    }
    ...
    public String getTicketText(){
        System.out.println(textToEmail.toString());
        return textToEmail.toString();
    }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        switch (m_iOutputType) {
        case OUTPUT_NONE:
            if (!"image".equals(qName) &&"play".equals(qName)) {
                try { 
            ...
            if ("image".equals(qName)){
                ...
                if (m_iTextLength > 0) {
                    ...
                    case DevicePrinter.ALIGN_RIGHT:
                        ...
                        textToEmail.append("<"+aux+" style='float:right;' ");
                        break;
                    ...
                    default: // DevicePrinter.ALIGN_LEFT
                        ...
                        textToEmail.append("<"+aux+" style='float:left;' ");
                        break;
                    }
                    textToEmail.append(" width='"+m_iTextLength+"'px ");
                ...
                textToEmail.append(">");
                textToEmail.append(text + "&nbsp;  </"+aux+">");
                text = null;
            } else if ("line".equals(qName)) {
                m_oOutputPrinter.endLine();
                textToEmail.append("</td></tr>");
            } else if ("ticket".equals(qName)) {
