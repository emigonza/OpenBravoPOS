...
//        m_jImage.setEnabled(true);
    ...
    public void writeValueEdit(Object value) {
        ...
        m_jImage.setImage((BufferedImage) cat[3]);
        /**
         * checkbox para hacer visible la categoria del producto - 
         * checkbox for make visible product category
         */
        jCheckBox1.setSelected((Boolean)cat[4]);
//        m_jName.setEnabled(true);
//        m_jCategory.setEnabled(true);
//        m_jImage.setEnabled(true);
...
//        m_jCatalogAdd.setEnabled(true);
    ...
    private void initComponents() {
        ...
        add(jCheckBox1);
        jCheckBox1.setBounds(380, 90, 180, 24);
