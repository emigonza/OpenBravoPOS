    ...
    private void btnPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayActionPerformed
        ...
        if (paymentdialog.showDialog(customerext.getCurdebt(), null)) {
            ...
            printTicket(paymentdialog.isPrintSelected()
                    ...
                    ticket, c);
            /**
             * Modificacion para el envío de informacion de abono de clientes - 
             * Change to send customer credit information
             */
            try{
                ...
                xml += "<entityDetail>";
                xml += "	<type>customer-payment</type>";
                xml += "	<detail>";
                xml += "	<customerID>" +customerext.getId() +"</customerID>";
                xml += "	<payment-value>" + total+"</payment-value>";
