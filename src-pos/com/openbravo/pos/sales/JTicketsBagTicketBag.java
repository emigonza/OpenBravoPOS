...
public class JTicketsBagTicketBag extends javax.swing.JPanel {
    ...
    public void showRefund(boolean canDelete) {
//        showView("refund");
        showView("edit");
    ...
    private void m_jBtnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jBtnDeleteActionPerformed
        /**
         * desabilita botones cuando se edita - disables buttons when editing
         */
        if(m_ticketsbagticket.getTicketCopy() != null && m_ticketsbagticket.getTicketCopy().getTicketId() == 0){
            int res = JOptionPane.showConfirmDialog(this, AppLocal.getIntString("message.wannadelete"), AppLocal.getIntString("title.editor"), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (res == JOptionPane.YES_OPTION) {
                m_ticketsbagticket.deleteTicket();
            }
        }else if(m_ticketsbagticket.getTicketCopyTovoid() != null){
            /**
             * Mensaje de anulacion - annulation message
             */
            if(canDelete){
                int res = JOptionPane.showConfirmDialog(this, AppLocal.getIntString("message.wannadelete"), AppLocal.getIntString("title.editor"), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                if (res == JOptionPane.YES_OPTION) {
                    m_ticketsbagticket.voidTicket();
                }
            }else{
               JOptionPane.showMessageDialog(this, AppLocal.getIntString("message.nodeleterefound"));
            }
        }
