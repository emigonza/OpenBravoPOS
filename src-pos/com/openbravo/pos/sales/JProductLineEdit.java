...
public class JProductLineEdit extends javax.swing.JDialog {
    ...
    private TicketLineInfo init(AppView app, TicketLineInfo oLine,ProductInfoExt proInfoExt, DataLogicSales dlSales,DataLogicSystem dlSystem) throws BasicException {
        ...
        //SMJ
        m_jNotes.setText(m_oLine.getProperty("notes"));
...
//        m_jPriceTax.addEditorKeys(m_jKeys);
    ...
    /**
     * modificacion para que se lance desde esta ventana la modificacion de precios de producto por unidad.
     * modified to be launched from this window the modification of product per unit prices.
     */
    private void changePrice() {
        JProducPriceSelector panel = new JProducPriceSelector(productInfoExt,dlSales,dlSystem,m_oLine.getProperty("unitid"));
        int acction = JOptionPane.showConfirmDialog(null, panel,LocalRes.getIntString("message.selectprice"),JOptionPane.OK_CANCEL_OPTION);
        if(acction == 0){
            double value  = panel.getSelectedPrice();
            String unityId = panel.getUnitId();
            m_jPrice.setDoubleValue(value);
            m_oLine.setPrice(value);
            m_oLine.setProperty("unitid", unityId);
    ...
    public static TicketLineInfo showMessage(Component parent, AppView app, TicketLineInfo oLine) throws BasicException {
        ...
        return myMsg.init(app, oLine,null,null,null);
    }
    
    public static TicketLineInfo showMessage(Component parent, AppView app, TicketLineInfo oLine,DataLogicSales dlSales,DataLogicSystem dlSystem) throws BasicException {
        Window window = getWindow(parent);
        ProductInfoExt productInfoExt = dlSales.getProductInfo(oLine.getProductID());
        ...
        return myMsg.init(app, oLine,productInfoExt, dlSales,dlSystem);
    }
    ...
    private void initComponents() {
        ...
        m_jNotes = new javax.swing.JLabel();
        ...
        m_jUnits.setBounds(100, 50, 230, 25);

        m_jPrice.setEnabled(false);
        jPanel2.add(m_jPrice);
        m_jPrice.setBounds(100, 80, 230, 25);

        m_jPriceTax.setEnabled(false);
        jPanel2.add(m_jPriceTax);
        m_jPriceTax.setBounds(100, 110, 230, 25);
        ...
        m_jTaxrate.setBounds(100, 140, 200, 25);

        jLabel5.setText(AppLocal.getIntString("label.tax")); // NOI18N
        jPanel2.add(jLabel5);
        jLabel5.setBounds(10, 140, 90, 15);

        jLabel6.setText(AppLocal.getIntString("button.note")); // NOI18N
        jPanel2.add(jLabel6);
        jLabel6.setBounds(10, 240, 90, 15);
        ...
        m_jTotal.setBounds(100, 200, 200, 25);
        ...
        m_jSubtotal.setBounds(100, 170, 200, 25);

        jLabel8.setText(AppLocal.getIntString("label.totalcash")); // NOI18N
        jPanel2.add(jLabel8);
        jLabel8.setBounds(10, 200, 90, 15);

        m_jNotes.setText("Ninguna");
        jPanel2.add(m_jNotes);
        m_jNotes.setBounds(100, 240, 210, 20);
        ...
        jButton1.setBounds(330, 77, 40, 30);
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    ...
    private javax.swing.JLabel m_jNotes;
