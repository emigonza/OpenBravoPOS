...
public class JTicketsBagRestaurant extends javax.swing.JPanel {
    ...
    public void activate() {
        ...
        // SMJ  - desactiva el boton de mover mesas y si el usuario no tiene permisos       
        jButton2.setEnabled(m_App.getAppUserView().getUser().hasPermission("com.openbravo.pos.sales.restaurant.JTicketsBagRestaurant"));
    }
    ...
    private void initComponents() {
        ...
        m_jDelTicket.setToolTipText("Cancelar Recibo Actual");
        ...
        jButton2.setToolTipText("Mover a otra mesa");
        ...
        jButton1.setToolTipText("Atender otras mesas");
    ...
    /**
     * modificacion para envio de mensajes XML de cancelacion de orden enviada a comanda cuando se cierra el ticket
     * modification for XML message sending cancellation order sent commands when you close the ticket
     */
    private void initTooltips() {
        m_jDelTicket.setToolTipText(AppLocal.getIntString("tooltiptext.deleteticket"));
        jButton1.setToolTipText(AppLocal.getIntString("tooltiptext.movetable"));
        jButton2.setToolTipText(AppLocal.getIntString("tooltiptext.meetothertable"));
    }
