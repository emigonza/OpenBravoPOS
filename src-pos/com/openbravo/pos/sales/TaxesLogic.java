...
public class TaxesLogic {
    ...
    public void calculateTaxes(TicketInfo ticket) throws TaxesException {
        ...
        boolean isCustomerTaxExempt = ticket.isCustomerTaxExempt();
        
        for (TicketLineInfo line: ticket.getLines()) {
            if(isCustomerTaxExempt && taxRateZero != null)
                line.setTaxInfo(taxRateZero);
    ...
    /**
     * Modificacion para el calculo de los impuestos según logica de negocio de restaurantes.(incluye clientes exentos de impuestos)
     * Modification for the computation of tax under the restaurant business logic. (Includes tax-exempt customers)
     * @param line
     * @return List<TicketTaxInfo>
    ...
    public List<TicketTaxInfo> calculateTaxes(TicketLineInfo line) throws TaxesException {
        ...
        return calculateLineTaxes(line.getSubValueWithDiscount(), taxesapplied);
    }
