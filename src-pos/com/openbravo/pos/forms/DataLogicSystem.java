...
//    public abstract BaseSentence getShutdown();
    ...
    public final Properties getResourceAsPropertiesFromString(String sName) {
        String resource = getResourceAsText(sName);
        
        java.util.Properties proper = new Properties();
        try {
            InputStream  inputStream = new ByteArrayInputStream(resource.getBytes("UTF-8"));
