...
public class TableDefinition {
    ...
    /**
     * crea el Sql dinamico para cargar las listas de las ventanas regresa SQL a ejecutar
     * Create dinamic SQL for load list into the windows, It returns SQL to ejecute.
     * @return String
     */
    public String getListSQL() {
        ...
        if(where != null && !where.equalsIgnoreCase(""))
            sent.append(where);
        /**
         * si tabla XXX adiciona clausula "order by"
         * if tabla XXX add "order by" clause
         */
        if(tablename.equalsIgnoreCase("RESOURCES")){
            sent.append(" order by NAME ");
        }
        else if(tablename.equalsIgnoreCase("CUSTOMERS")){
            sent.append(" order by TRIM(NAME) asc ");
        }
        else if(tablename.equalsIgnoreCase("CATEGORIES")){
            sent.append(" order by TRIM(NAME) asc ");
        }
        else if(tablename.equalsIgnoreCase("TAXES")){
            sent.append(" order by TRIM(NAME) asc ");
        }
        else if(tablename.equalsIgnoreCase("TAXCATEGORIES")){
            sent.append(" order by TRIM(NAME) asc ");
        }
        else if(tablename.equalsIgnoreCase("TAXCUSTCATEGORIES")){
            sent.append(" order by TRIM(NAME) asc ");
        }
        ...
        else if(tablename.equalsIgnoreCase("FLOORS")){
            sent.append(" order by TRIM(NAME) asc ");
        }
        else if(tablename.equalsIgnoreCase("PLACES")){
            sent.append(" order by floor, TRIM(NAME) asc ");
        }
